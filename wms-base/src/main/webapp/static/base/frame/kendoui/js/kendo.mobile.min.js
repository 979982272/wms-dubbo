...
(function($, undefined) {
    ...
    var Pane = Widget.extend({
        ...
        _setupAppLinks: function() {
            ...
            // remove the ms-touch-action added by the processor events, breaks native scrolling in WP8
...
(function($, undefined) {
    var kendo = window.kendo,
        ...
        viewportTemplate = kendo.template('<meta content="initial-scale=#: data.scale #, maximum-scale=#: data.scale #, processor-scalable=no#=data.height#" name="viewport" />', {usedWithBlock: false}),
...
(function($, undefined) {
    ...
    var ListView = Widget.extend({
        init: function(element, options) {
            ...
            // HACK!!! to negate the ms touch action from the processor events.
